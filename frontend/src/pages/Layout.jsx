    ...
    return (
        <div className="min-h-screen w-full relative">
            <div className="fixed w-full">
                <Navbar value={{userData,Note}} />
                <Notes value={{ Note, setNotes, FormOpen, setFormOpen, update, setUpdate, title1, tags1, tag1, content1, setContent1, setTag1, setTags1, setTitle1, id, setId }} />
            </div>
            {FormOpen && <div className="absolute z-10 w-full min-h-screen  flex justify-center items-center bg-black bg-opacity-30 backdrop-blur-sm transition-opacity duration-300 ease-in-out">
                <NoteForm value={{ FormOpen, setFormOpen, Note, setNotes, update, setUpdate, title1, tags1, tag1, content1, setContent1, setTag1, setTags1, setTitle1, id, setId }} />
            </div>}
